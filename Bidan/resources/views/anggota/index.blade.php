  ...
  <div class="col-lg-12">
    <div class="card bg-default">
      <div class="card-header bg-transparant">
        <h3 class="card-title text-dark mb-0">Data Anggota</h3>
        {{-- Tomboh tambah --}}
        <a href="{{ route('anggota.create') }}" class="btn btn-white mb-3 btn-rounded">Tambah Anggota</a>
          ...
          <table class="table align-items-center text-dark table-bordered">
            ...
            <tbody>
              @foreach ($anggota as $item)
                <tr>
                  <td class="text-center"><img src="{{ url('fotoanggota/'.$item['url_anggota'])}}" style="max-width: 50px"></td>
                  ...
                  <td class="text-center">
                    <a href="{{ route('anggota.edit', $item['id']) }}" class="btn btn-rounded btn-warning">
                      <i class="menu-icon mdi mdi-pencil"></i>
                      <span class="menu-title">Edit</span>
                    </a>
                    <form method="POST" action="{{ route('anggota.destroy', $item['id']) }}" style="display:inline-block">
                      @csrf
                      @method('DELETE')
